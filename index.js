...
const category = require(__dirname+'/App/Controllers/admin/category.js');
const product = require(__dirname+'/App/Controllers/admin/product.js');
const blog = require(__dirname+'/App/Controllers/admin/blogs.js');
const news = require(__dirname+'/App/Controllers/admin/news.js');
const client = require(__dirname+'/App/Controllers/admin/speak.js');
